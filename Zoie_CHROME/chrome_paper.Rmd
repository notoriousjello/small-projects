...
rr_lt <- clinical_lab_msd %>%
  filter(ucr_norm_ang2_tertile == 1)
summary(rr_lt$ucr_norm_ang2)

rr_mt <- clinical_lab_msd %>%
  filter(ucr_norm_ang2_tertile == 2)
summary(rr_mt$ucr_norm_ang2)

rr_ht <- clinical_lab_msd %>%
  filter(ucr_norm_ang2_tertile == 3)
summary(rr_ht$ucr_norm_ang2)
...
result <- glm(death_dialysis ~ tertile_rr, 
              data = rr_mt_lt,
              family = "poisson")
...
# regression on lowest/middle tertile with adjustment
result <- glm(death_dialysis ~ tertile_rr + age + male + bmi + mv + covid_confirmed + myrace, 
              data = rr_mt_lt,
              family = "poisson")
...
# death_dialysis
# unadjusted model
result <- glm(death_dialysis ~ ucr_norm_ang2_scaled, 
              data = clinical_lab_msd_no_outlier,
              family = "poisson")
...
# adjusted model
result <- glm(death_dialysis ~ ucr_norm_ang2_scaled + age + male + bmi + mv + covid_confirmed + myrace, 
              data = clinical_lab_msd_no_outlier,
              family = "poisson")
...
# dialysis_study
# unadjusted model
result <- glm(dialysis_study ~ ucr_norm_ang2_scaled, 
              data = clinical_lab_msd_no_outlier,
              family = "poisson")
...
# adjusted model
result <- glm(dialysis_study ~ ucr_norm_ang2_scaled + age + male + bmi + mv + covid_confirmed + myrace, 
              data = clinical_lab_msd_no_outlier,
              family = "poisson")
...
# death_hospital
# unadjusted model
result <- glm(death_hospital ~ ucr_norm_ang2_scaled, 
              data = clinical_lab_msd_no_outlier,
              family = "poisson")
...
# adjusted model
result <- glm(death_hospital ~ ucr_norm_ang2_scaled + age + male + bmi + mv + covid_confirmed + myrace, 
              data = clinical_lab_msd_no_outlier,
              family = "poisson")
...
```{r}
write_xlsx(clinical_lab_msd,
          "B:/Lab Members/Zoie/Paper/20231117_chr_data.xlsx")
```
